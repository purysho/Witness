...
PROVIDER_TS = """export interface ProviderSettings { embedding_mode:"hash"|"sentence-transformers"; embedding_model:string; embedding_dimensions:number; visual_mode:"off"|"hash"; visual_dimensions:number; updated_at:string; }
...
DEMO_TS = """export interface DemoLoadResult { source_versions:Record<string,string>; dataset:EvalDatasetSummary; attack_manifest:AttackManifestSummary; suggested_question:string; source_directory:string; artifact_directory:string; }
"""
