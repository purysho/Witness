...
export interface AttackCaseComparison { case_id:string; question:string; clean_state:SufficiencyState|null; attacked_state:SufficiencyState|null; clean_passed:boolean; attacked_passed:boolean; clean_query_run_id:string|null; attacked_query_run_id:string|null; recall_delta:number|null; precision_delta:number|null; citation_coverage_delta:number|null; }
